...
$prv_unauth_msg = urlencode ("<b>Hᴇʟʟᴏ Tʜᴇʀᴇ!! <a href='tg://user?id=$userId'>$firstname</a>\nUsᴇʀ ɪᴅ: <code>$userId</code> \n\nSᴏʀʀʏ, Bᴜᴛ Yᴏᴜ Aʀᴇ Nᴏᴛ Aʟʟᴏᴡᴇᴅ Tᴏ Usᴇ Tʜɪs Bᴏᴛ! \nCoɴᴛᴀᴄᴛ @mafia_xdd Tᴏ Gᴇᴛ Aᴄᴄᴇss..!!</b>\n");

$vip_unauth_msg = urlencode ("<b>Hᴇʟʟᴏ Tʜᴇʀᴇ!! <a href='tg://user?id=$userId'>$firstname</a>\nUsᴇʀ ɪᴅ: <code>$userId</code> \n\nSoʀʀʏ, Bᴜᴛ Yᴏᴜ Aʀᴇ Nᴏᴛ ᴀ VIP ᴜsᴇʀ! \nYoᴜ Nᴇᴇᴅ Tᴏ Bᴇ VIP Tᴏ Usᴇ Tʜɪs Gᴀᴛᴇs.!</b>\n");

$premium_unauth_msg = urlencode ("<b>Hᴇʟʟᴏ Tʜᴇʀᴇ!! <a href='tg://user?id=$userId'>$firstname</a>\nUsᴇʀ ɪᴅ: <code>$userId</code> \n\nSoʀʀʏ, Bᴜᴛ Yᴏᴜ Aʀᴇ Nᴏᴛ ᴀ Pʀᴇᴍɪᴜᴍ Usᴇʀ! \nYoᴜ Nᴇᴇᴅ Tᴏ Bᴇ Pʀᴇᴍɪᴜᴍ Tᴏ Usᴇ Tʜɪs Gᴀᴛᴇs.!</b>\n");

$spam_unauth_msg = urlencode ("<b>Hᴇʟʟᴏ Tʜᴇʀᴇ!! <a href='tg://user?id=$userId'>$firstname</a>\nUsᴇʀ ɪᴅ: <code>$userId</code> \n\nSoʀʀʏ, Bᴜᴛ Yᴏᴜ Aʀᴇ Tʀʏɪɴɢ Tᴏ Aᴄᴄᴇss Uɴᴀᴜᴛʜᴏʀɪsᴇ Cᴏɴᴛᴇɴᴛ! \nTʜɪs Wɪʟʟ Lᴇᴀᴅs Tᴏ Sᴘᴀᴍ Aɴᴅ Yᴏᴜ Mᴀʏ Gᴏᴛ Bᴀɴɴᴇᴅ.!</b>\n");
...
if (strpos($message, "/start") === 0){
  $respo = urlencode ("<b>Hᴇʟʟᴏ ᴛʜᴇʀᴇ!! @$username \nUsᴇʀ ɪᴅ: <code>$userId</code>\n
Tʏᴘᴇ /cmds Tᴏ Kɴᴏᴡ Aʟʟ Mʏ Cᴏᴍᴍᴀɴᴅs!!</b>\n\n\n<i>Pʟᴇᴀsᴇ Cᴏɴᴛᴀᴄᴛ @mafia_xdd Tᴏ Gᴇᴛ Fʀᴇᴇ Aᴄᴄᴇss Tᴏ Tʜᴇ Bᴏᴛ.</i>\n\n<b>Bᴏᴛ Mᴀᴅᴇ Bʏ:</b><a> [MAFIA XD]</a>");
