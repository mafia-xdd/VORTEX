...
sendMessage($chatId, '▬▬▬▬»[[ <b>G -> FR AUTH</b> ]]«▬▬▬▬%0A<b>Card</b> => <i><code>'.$lista.'</code>%0A</i><b>Responce</b> => <i>Zip Failed Validation.%0A</i><b>Status</b> => <i>LIVE! ✅ </i><b>[CVV-M]{AVS-N}%0A</b><i>————————»«————————%0A</i><b>Bin Data</b> => <i>'.$type.'-'.$brand.' -> '.$code.'('.$emoji.')%0A</i><b>Bank</b> => <i>'.$bank.'%0A</i><i>————————»«————————%0A%0A</i><b>Proxy: </b><i>'.$ip.'%0A</i><b>Time Taken: </b><i>'.$time.'s%0A</i><b>Checked By: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>Bot Made by:</b><a> [ᴍᴀғɪᴀ々xᴅ]</a>', $message_id);
}
...
sendMessage($chatId, '▬▬▬▬»[[ <b>G -> FR AUTH</b> ]]«▬▬▬▬%0A[<b>Card</b>] -> <i><code>'.$lista.'</code>%0A</i>[<b>Status</b>] -> <b>APPROVED!</b> ✅%0A[<b>Result</b>] -> [<b>CCN-M</b>]%0A<i>——————————»«——————————%0A</i>[<b>Bin Info</b>] -> <i>'.$type.'-'.$brand.' -> '.$code.'('.$emoji.')%0A</i>[<b>Bank</b>] => <i>'.$bank.'%0A</i><i>——————————»«——————————%0A%0A</i><b>Proxy: </b><i>'.$ip.'%0A</i><b>Time Taken: </b><i>'.$time.'s%0A</i><b>Checked By: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>Bot Made by:</b><a> [ᴍᴀғɪᴀ々xᴅ]</a>', $message_id);
}
...
sendMessage($chatId, '<b>Card</b> => <i><code>'.$lista.'</code>%0A</i><b>Responce</b> => <i>An error occurred while processing the card. Please try again in few minutes.%0A</i><b>Status</b> => <i>ERROR! [Try On Other Gate.!]%0A</i><b>Gate</b> => Freemius.%0A<i>————————»«————————%0A%0A</i><b>Proxy: </b><i>'.$ip.'%0A</i><b>Time Taken: </b><i>'.$time.'s%0A</i><b>Checked By: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>Bot Made by:</b><a> [ᴍᴀғɪᴀ々xᴅ]</a>', $message_id);
}
...
sendMessage($chatId, '<b>Card</b> => <i><code>'.$lista.'</code>%0A</i><b>Responce</b> => <i>Your Email is Invalid or Flaaged.!%0A</i><b>Status</b> => <i>ERROR! ❌ [Try Again.]%0A</i><b>Gate</b> => Freemius.%0A<i>————————»«————————%0A%0A</i><b>Proxy: </b><i>'.$ip.'%0A</i><b>Time Taken: </b><i>'.$time.'s%0A</i><b>Checked By: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>Bot Made by:</b><a> [ᴍᴀғɪᴀ々xᴅ]</a>', $message_id);
}

elseif (strpos($result2, '-1')){
sendMessage($chatId, '<b>Card</b> => <i><code>'.$lista.'</code>%0A</i><b>Responce</b> => <i>Update Noise(-1).!%0A</i><b>Status</b> => <i>ERROR! ❌ [Report this to owner.!]%0A</i><b>Gate</b> => Freemius.%0A<i>————————»«————————%0A%0A</i><b>Proxy: </b><i>'.$ip.'%0A</i><b>Time Taken: </b><i>'.$time.'s%0A</i><b>Checked By: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>Bot Made by:</b><a> [ᴍᴀғɪᴀ々xᴅ]</a>', $message_id);
}
...
elseif(!$result2){
sendMessage($chatId, '<b>Card</b> => <i><code>'.$lista.'</code>%0A</i><b>Responce</b> => <i>'.$result2.'%0A</i><b>Status</b> => <i>Dont Know!❌  [try Again, or Report to owner.!]%0A</i><b>Gate</b> => Freemius.%0A<i>————————»«————————%0A%0A</i><b>Proxy: </b><i>'.$ip.'%0A</i><b>Time Taken: </b><i>'.$time.'s%0A</i><b>Checked By: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>Bot Made by:</b><a> [ᴍᴀғɪᴀ々xᴅ]</a>', $message_id);
}
else{
sendMessage($chatId, '<b>Card</b> => <i><code>'.$lista.'</code>%0A</i><b>Responce</b> => <i>'.$result2.'%0A</i><b>Status</b> => <i>Error ❌ [try Again, or Report to owner.!]%0A</i><b>Gate</b> => Freemius.%0A<i>————————»«————————%0A%0A</i><b>Proxy: </b><i>'.$ip.'%0A</i><b>Time Taken: </b><i>'.$time.'s%0A</i><b>Checked By: </b><i>@'.$username.'%0A</i><b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>Bot Made by:</b><a> [ᴍᴀғɪᴀ々xᴅ]</a>', $message_id);
}
curl_close($ch);
